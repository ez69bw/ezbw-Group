...
run_async
def list_handlers2(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@user_admin
def filters2(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = msg.text.split(None, 1)  # use python's maxsplit to separate Cmd, keyword, and reply_text
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@user_admin
def stop_filter2(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = update.effective_message.text.split(None, 1)
...
@run_async
def reply_filter2(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    message = update.effective_message  # type: Optional[Message]
    to_match = extract_text(message)
    if not to_match:
...
@run_async
def list_handlers3(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@user_admin
def filters3(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    msg = update.effective_message  # type: Optional[Message]
    args = msg.text.split(None, 1)  # use python's maxsplit to separate Cmd, keyword, and reply_text
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@user_admin
def stop_filter3(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    user = update.effective_user  # type: Optional[User]
    args = update.effective_message.text.split(None, 1)
...
@run_async
def reply_filter3(bot: Bot, update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
    message = update.effective_message  # type: Optional[Message]
    to_match = extract_text(message)
    if not to_match:
...
FILTER_HANDLER2 = DisableAbleCommandHandler("filter2", filters2)
STOP_HANDLER2 = DisableAbleCommandHandler("stop2", stop_filter2)
LIST_HANDLER2 = DisableAbleCommandHandler("filters2", list_handlers2, admin_ok=True)
CUST_FILTER_HANDLER2 = MessageHandler(CustomFilters.has_text, reply_filter2)
FILTER_HANDLER3 = DisableAbleCommandHandler("filter3", filters3)
STOP_HANDLER3 = DisableAbleCommandHandler("stop3", stop_filter3)
LIST_HANDLER3 = DisableAbleCommandHandler("filters3", list_handlers3, admin_ok=True)
CUST_FILTER_HANDLER3 = MessageHandler(CustomFilters.has_text, reply_filter3)

dispatcher.add_handler(FILTER_HANDLER)
dispatcher.add_handler(STOP_HANDLER)
dispatcher.add_handler(LIST_HANDLER)
dispatcher.add_handler(CUST_FILTER_HANDLER, HANDLER_GROUP)
dispatcher.add_handler(FILTER_HANDLER2)
dispatcher.add_handler(STOP_HANDLER2)
dispatcher.add_handler(LIST_HANDLER2)
dispatcher.add_handler(CUST_FILTER_HANDLER2, HANDLER_GROUP2)
dispatcher.add_handler(FILTER_HANDLER3)
dispatcher.add_handler(STOP_HANDLER3)
dispatcher.add_handler(LIST_HANDLER3)
dispatcher.add_handler(CUST_FILTER_HANDLER3, HANDLER_GROUP3)
