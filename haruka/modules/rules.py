...
def send_rules(update, chat_id, from_pm=False):
    ...
    if from_pm and rules:
        ...
        update.effective_message.reply_text("Kalo tulisan nya kotak kotak adudu, klik aja yang ada dibawah.",
...
def set_rules(bot: Bot, update: Update):
    ...
    if len(args) == 2:
        ...
        update.effective_message.reply_text("Berhasil menambahkan rules.")
